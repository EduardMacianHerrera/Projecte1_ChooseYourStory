    ...
    try:
        ...
        for j in adventures:
            ...
            if count_scroll%3 ==0:
                print(to_print)
                to_print =""
                cont =input("Do you want to scroll down? (scroll: + / get out: 0)? ")
                print("")
                if cont == "0":
                    break
        print(to_print)
...
# getFormatedAdventures(Parrafos a imprimir, ancho total, titulos de parrafos, separaciones entre parrafos)
